...
A community‑driven evolution of Fungus‑style visual scripting.
...
# ✨ Key Improvements Over Fungus
    ...
    • Built‑in tweening system 
        ...
        ◦ This sys also works as a bridge to make it easier to create bindings letting you use stuff like LeanTween and DoTween. In fact, we have those in the works!
...
## Unity 6+ (Git URL)
Add these two packages via Package Manager → + → Add package from git URL:
    • https://github.com/Atelier-Mycelia/UnityUtils.git?path=Packages/com.ateliermycelia.unityutils
    • https://github.com/Atelier-Mycelia/Hyphlow.git?path=Assets/Hyphlow
...
# 🙏 Acknowledgements
    • The developers and contributors of Fungus and Fungus Community Edition
